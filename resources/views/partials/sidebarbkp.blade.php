...
>
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->is('my-matches') ? 'active' : '' }}"
           href="#">
            <i class="fas fa-calendar-alt me-2"></i> Matches (Live / Upcoming / Recent)
        </a>
    </li>

      <li class="nav-item">
        <a class="nav-link nav-link {{ request()->routeIs('feed') ? 'active' : '' }}" href="{{ route('feed') }}">
             <i class="fas fa-rss me-2"></i> Content Feed
        </a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->is('fan-zone') ? 'active' : '' }}"
           href="#">
            <i class="fas fa-users me-2"></i> Leaderboards
        </a>
    </li>
